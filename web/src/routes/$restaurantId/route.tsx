        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              {data?.restaurantName} is a charming and cozy restaurant that
              offers a delightful dining experience. Nestled in the heart of the
              city, our establishment celebrates the rich flavors of{" "}
              {data?.cuisines} with a focus on using the freshest seasonal
              ingredients.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">info@rustictistro.com</p>
              </div>
            </div>
          </div>
